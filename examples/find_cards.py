...
print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
print("This deck issuer has issued: {cards} cards.".format(
      cards=sum([i.amounts[0] for i in cards if i.type == "CardIssue"])))

print("Peers on this deck have transacted {cards} cards in {transfers} card transactions.".format(
      cards=sum([i.amounts[0] for i in cards if i.type == "CardTransfer"]),
...
print("Peers on this deck have burned {cards} cards in {transfers} card transactions.".format(
      cards=sum([i.amounts[0] for i in cards if i.type == "CardBurn"]),
