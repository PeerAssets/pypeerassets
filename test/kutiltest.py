...
def test_key_generation_from_seed():
    ...
    mykey = Kutil(from_string=seed, network="ppc")
...
def test_wif_import():
    ...
    mykey = Kutil(network="ppc", from_wif="7A6cFXZSZnNUzutCMcuE1hyqDPtysH2LrSA9i5sqP2BPCLrAvZM")

    assert mykey.address == 'PJxwxuBqjpHhhdpV6KY1pXxUSUNb6omyNW'
    assert mykey.pubkey == '02a119079ef5be1032bed61cc295cdccde58bf70e0dd982399c024d1263740f398'
    assert mykey.privkey == 'b43d38cdfa04ecea88f7d9d7e95b15b476e4a6c3f551ae7b45344831c3098da2'
